...
# import all domain models so they register on Base.metadata before autogenerate runs
...
# Override the .ini's sqlalchemy.url with DATABASE_URL from the environment,
# so local dev / CI / production never need to hardcode credentials in alembic.ini.
