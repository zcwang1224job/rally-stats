...
| 2 | `AuthService.loggedIn()` is `true` | Shell shows: home link, groups link, member-home/settings/match-history links, logout action. No login/register links render. | FR-002, FR-007, spec US1 scenario 2, US3 scenario 1 |
